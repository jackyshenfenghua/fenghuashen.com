...
for (const requiredText of [
  ...
  'Project planning, scheduling, progress management, cost control, contracts, payment and collection-related controls, and management reporting across complex project environments.',
  'Project Risk Management',
  'Experience across the project risk management cycle, including risk identification, qualitative and quantitative analysis, risk response planning, and contingency management.',
  'Risk Identification',
  'Qualitative Risk Analysis',
  'Quantitative Risk Analysis',
  'Risk Response Planning',
  'Contingency Management',
  'Hands-on exploration of AI-assisted workflows, enterprise knowledge systems, automated reporting, analytics, local/private LLM deployment and digital product prototyping.',
